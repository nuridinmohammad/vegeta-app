...
const ProductHistory: React.FC<ProductHistoryProps> = ({ products }: ProductHistoryProps) => {
            ...
            <div className="flex gap-6">
              <div className="p-1 border rounded-xl overflow-hidden">
                <div className="w-[80px] h-[80px] relative">
                  <Image src={"/vegetables.jpeg"} layout="fill" alt="" objectFit="contain" />
                </div>
              </div>
              <div className="flex-1 flex flex-col gap-1">
                <div className="text-lg font-semibold text-text-black">{mainProduct.name}</div>
                <div className="text-sm text-text-black">
                  {mainProduct.itemCount} {mainProduct.unit} x Rp {formatNumber(mainProduct.price)}
                </div>
                <div className="text-sm font-semibold text-text-black">dan {products.length - 1} item lainnya</div>
              </div>
              <div className="flex w-auto">
                <div className="w-[226px] flex flex-col gap-2 border-r">
                  <div className="flex gap-4 items-baseline">
                    <div className="text-sm">21 Juli 2023</div>
                    <div className="rounded-sm px-2 bg-leaf text-white text-xs font-semibold">Berhasil</div>
                  </div>
