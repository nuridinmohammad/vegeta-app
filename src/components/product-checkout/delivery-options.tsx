    ...
    <>
      ...
      <div className="flex gap-6">
        ...
        >
          ...
          <div className="text-sm text-gray-400">Akan tiba maksimal pukul 17.00 WIB</div>
        ...
        >
          ...
          <div className="text-sm text-gray-400">Ambil pesanan anda secara mandiri di store</div>
      ...
      {deliveryMethod === "HOME_DELIVERY" && (
        <>
          ...
          <div className="w-full flex flex-col gap-4">
            <Input className="w-full p-4" type="text" placeholder="Nama Lengkap" />
            <Input className="w-full p-4" type="text" placeholder="Nomor Telepon" />
            <Textarea placeholder="Alamat Lengkap" />
            <div className="flex w-full gap-4">
              <Input className="flex-1 p-4" type="text" placeholder="Provinsi" />
              <Input className="flex-1 p-4" type="text" placeholder="Kota/Kabupaten" />
            </div>
            <div className="flex w-full gap-4">
              <Input className="flex-1 p-4" type="text" placeholder="Kecamatan" />
