...
const IconBag: React.FC<IconProps> = ({ className = "", fill = "primary", stroke = "accent" }: IconProps) => {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path d="M2.5 5H17.5" stroke={`var(--${stroke})`} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path
