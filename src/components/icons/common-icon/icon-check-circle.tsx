...
const IconCheckCircle: React.FC<IconProps> = ({ className = "", fill = "primary", stroke = "accent" }: IconProps) => {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_69_7698)">
        ...
        />
        <path d="M18.3333 3.33331L10 11.675L7.5 9.17498" stroke={`var(--${stroke})`} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </g>
    </svg>
  );
};
