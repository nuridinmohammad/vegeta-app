...
const IconMagnifier: React.FC<IconProps> = ({ className = "", fill = "primary", stroke = "accent" }: IconProps) => {
  return (
    <svg className={className} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path d="M14.6667 14.6667L13.3334 13.3333" stroke={`var(--${stroke})`} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
