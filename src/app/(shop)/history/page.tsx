      ...
      <div className="w-content flex gap-6">
        <div className="m-5 p-5 flex flex-col flex-[1] border rounded-xl items-center gap-2 ">
          ...
          <div className="w-[100%] gap-3 flex flex-col">
            ...
            <div className="">
              ...
              <div className="text-[20px] font-bold text-leaf">Rp 1.300.000</div>
            </div>
            <div className="mt-3">
              <div>Saldo saat ini</div>
              <div className="text-[20px] font-bold text-carrot">Rp 300.000</div>
            </div>
          </div>
        ...
        <div className="m-5 flex-[3]">
          <div className="flex justify-between">
            <div className="text-leaf text-3xl font-semibold">Riwayat Belanja</div>
          ...
          {transactions.map((transaction, index) => (
            <ProductHistory key={`productHistory${index}`} products={transaction.products} />
          ))}
